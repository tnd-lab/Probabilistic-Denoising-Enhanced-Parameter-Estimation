...
R_data = load('results/Numerical_r_tars_other_methods.mat');
V_data = load('results/Numerical_v_tars_other_methods.mat');
...
% Compute MSE
method_names = ["MF_CFAR", "MF_CLEAN", "MF_MUSIC", "PDNet_CFAR", "DnCNN_CFAR"];
...
plot_results(SNRs_Tx, NMSE_results)

function fig = plot_results(SNRsdb, results_struct)
    ...
    for m = 1:num_methods
        ...
        h_range(m) = semilogy(ax1, SNRsdb, ydata, ...
            ...
            'DisplayName', strrep(method_names{m}, '_', '-'));
    end
