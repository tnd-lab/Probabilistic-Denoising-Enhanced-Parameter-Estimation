...
for idx_SNR = 1:length(SNRs_Tx)
    ...
    for idx_trial = 1:num_of_trials
        ...
        for idx_tar = 1:num_of_targets
            ...
            y_PRBS_waveform_no_noise = y_PRBS_waveform_no_noise + generate_signal_model_parametric(target_distance, target_speed, alpha_tar, p_prbs, T_chip, T_prbs, fc, c, num_of_chips, num_of_bits);
