...
for idx_SNR = 1:length(SNRs_Tx)
    ...
    for idx_time = 1:length(time_steps)
        ...
        root_dir = '/Users/rysheng/Downloads/chip255_symbol256_1target/mats/freq';
        root_dir_eval = "/Users/rysheng/Library/CloudStorage/OneDrive-polymtl/PhD/NghiaThinhNguyen_Paper_Joint_Radar_Communications/ml/evals/time";
        ...
        for idx_trial = 1:num_of_trials
            ...
            % MLE: Y
            [hat_r_tars, hat_v_tars] = est_rv_mle_y(ifft(Y_PRBS_waveform), p_prbs, noise_power, P_sensing, target_distance, target_speed, fc, T_chip, T_prbs);
            Numerical_r_tars(idx_time, idx_SNR, idx_trial, :, 1) = hat_r_tars;
            Numerical_v_tars(idx_time, idx_SNR, idx_trial, :, 1) = hat_v_tars;


            % MLE: Z
            [hat_r_tars, hat_v_tars] = est_rv_mle_z(ifft(Z_PRBS_waveform), p_prbs, noise_power, P_sensing, target_distance, target_speed, fc, T_chip, T_prbs);
            ...
            [hat_r_tars, hat_v_tars] = est_rv_mle_z(z_PRBS_waveform_PDNet_Y_no_afm, p_prbs, noise_power, P_sensing, target_distance, target_speed, fc, T_chip, T_prbs);
            ...
            [hat_r_tars, hat_v_tars] = est_rv_mle_z(z_PRBS_waveform_DnCNN_Y_no_afm, p_prbs, noise_power, P_sensing, target_distance, target_speed, fc, T_chip, T_prbs);
...
% Save the results
save('Numerical_r_tars_mle_method.mat', 'Numerical_r_tars', '-v7.3');
save('Numerical_v_tars_mle_method.mat', 'Numerical_v_tars', '-v7.3');
