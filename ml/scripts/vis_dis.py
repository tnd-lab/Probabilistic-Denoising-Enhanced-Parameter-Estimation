...
from configs.data import categories, output_dir, root_dir, transform_funcs, snrs
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        for batch_idx, batch_images in enumerate(tqdm(test_loader)):
            ...
            distributions = {
                ...
                r"$p(\mathbf{Y}_{\rm sen}^{\rm t})$": Y_PRBS_waveform,
                r"$p(\mathbf{\tilde{Z}}_{\rm sen}^{\rm t})$": Z_PRBS_waveform_no_noise,
                r"$p(\mathbf{Z}_{\rm sen}^{\rm t})$": Z_PRBS_waveform,
            }

            distributions = model.distribution(
                Y_PRBS_waveform, Z_PRBS_waveform_no_noise, distributions
            )
    ...
    comparation_groups = [
        [
            r"$p(\mathbf{\tilde{Z}}_{\rm sen}^{\rm t})$",
            r"$p(\mathbf{Z}_{\rm sen}^{\rm t})$",
            r"$p(\mathbf{Y}_{\rm sen}^{\rm t})$",
        ],
        [
            r"$p(\mathbf{\tilde{Z}}_{\rm sen}^{\rm rd})$",
            r"$p(\mathbf{Y}_{\rm sen}^{\rm rd})$",
        ],
        ...
        [
            r"$p(\mathbf{\tilde{Z}}_{\rm sen}^{\rm rd})$",
            r"$p(\mathbf{\hat{Z}}_{\rm sen}^{\rm rd})$",
        ],
        [
            r"$p(\mathbf{\tilde{Z}}_{\rm sen}^{\rm t})$",
            r"$p(\mathbf{\hat{Z}}_{\rm sen}^{\rm t})$",
        ],
    ]
